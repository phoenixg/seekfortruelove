...
return array(
	...
	*/
	...
	"count"          => ":attribute 必须有正好 :count 个已选元素。",
	"countbetween"   => ":attribute 必须有介于 :min 和 :max 个已选元素。",
	"countmax"       => ":attribute 必须有小于 :max 个已选元素。",
	"countmin"       => ":attribute 必须有大于 :min 个已选元素。",
    ...
    "required_with"  => ":attribute 属性当 :field 存在时为必填项。",
