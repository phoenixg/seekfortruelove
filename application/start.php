...
set_path('image_profile_tmp', path('public') . 'images' . DS . 'profile' . DS . 'tmp' . DS);
...
{
    return Swift_SmtpTransport::newInstance(Config::get('application.mail_smtp_addr'), Config::get('application.mail_smtp_port'), 'ssl')
